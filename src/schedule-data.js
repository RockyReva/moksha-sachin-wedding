...
// Set to false to disable RSVP (e.g. after deadline). Guests will see "RSVP has closed" instead of the form.
...
// Photos go in public/schedule/ folder. Use paths like "schedule/filename.png".
export const SCHEDULE_EVENTS = [
  {
    time: "Dec 19 · 5:00 PM",
  ...
  },
  {
    ...
    photos: ["schedule/2-Bale_Birud.jpeg"],
  },
  {
    ...
    photos: ["schedule/3-Wedding_Day.jpeg"],
  },
  {
    time: "Dec 20 · 4:00 PM",
    ...
    icon: "🏺",
    customIcon: "/schedule/ganga_pooja_icon.svg",
    ...
    photos: ["schedule/1-Oorukuduva.jpeg"],
  },
];
