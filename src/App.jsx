...
// Venue: Map embed. Google Maps (zoom 8) when API key set; else OpenStreetMap
...
const VENUE_MAP_EMBED = GOOGLE_MAPS_KEY
  ? `https://www.google.com/maps/embed/v1/place?key=${GOOGLE_MAPS_KEY}&q=${VENUE_LAT},${VENUE_LNG}&zoom=8`
